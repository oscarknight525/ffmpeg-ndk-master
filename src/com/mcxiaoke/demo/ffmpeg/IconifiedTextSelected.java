...
public class IconifiedTextSelected implements Comparable<IconifiedTextSelected>{
	...
	public IconifiedTextSelected(String text, Drawable bullet, boolean selected, boolean visibility, int _type) {
	...
	public IconifiedTextSelected(String text, Drawable bullet, boolean selected, boolean visibility, int cid, int rid, int _type) {
		//mIcon = new SoftReference<Drawable>(bullet);
		if ((_type==0) || (_type == 21) || (_type == 22)) {
			mHardIcon = bullet;
		} else {
